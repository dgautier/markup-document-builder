...
image:https://github.com/dgautier/markup-document-builder/actions/workflows/build.yml/badge.svg?branch=master["Build Status", link="https://github.com/dgautier/markup-document-builder/actions/workflows/build.yml"]image:https://codecov.io/gh/dgautier/markup-document-builder/graph/badge.svg?token=WSS4XQBATU["Coverage Status", link=https://codecov.io/gh/dgautier/markup-document-builder] image:http://img.shields.io/badge/license-ASF2-blue.svg["Apache License 2", link="http://www.apache.org/licenses/LICENSE-2.0.txt"]
...
The project requires at least JDK 17.

Forked from : https://github.com/Swagger2Markup/markup-document-builder[markup-document-builder]
